...
//import  mishagramLogo from "./MishagramLogo.svg";

const Menu = () => {

  const [active, setActive] = React.useState<string | null>(null);
  const activeTab = (e:any)=>{
   let qwertyy: HTMLElement | null;

   if(active && active != "Notifications"){
    qwertyy = document.querySelector(`.${active}`)?.firstChild?.firstChild as HTMLElement;
    qwertyy.style.fill = "#000000";
    qwertyy.style.color = "#ffffff";
   }
